...
def register():
    ...
    inflabelpassword = Label (mainFrame,text="must be minimum of 8 characters", background=background)
    inflabelpassword1 = Label (mainFrame,text="1 lowercase, 1 number ", background=background)
    inflabelpassword2 = Label (mainFrame,text="1 special character,1 uppercase", background=background)
    ...
    # Buttons
    signupButton = Button(mainFrame, text="Sign up", command= lambda: [register_verify(user.get(), password.get(), postcode.get(), mobile.get()), password_check(password)])
    ...
    inflabelpassword.place( x=120, y=185)
    inflabelpassword1.place( x=120, y=200)
    inflabelpassword2.place( x=120, y=215)


    postcodeLabel.place(width=150, x=120, y=240)
    postcode.place(width=200, x=120, y=260)

    mobileLabel.place(width=150, x=120, y=290)
    mobile.place(width=200, x=120, y=310)

    #loginButton.place(width=80, x=160, y=340)
    signupButton.place(width=80, x=180, y=420)

    accountExists.place(width=124, x=88, y=450)
